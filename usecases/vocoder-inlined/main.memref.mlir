...
func private @write_samples(i32, memref<512xi16>) -> (i32) attributes {llvm.emit_c_interface}
func private @pitch(i32, (i32, memref<1xi8>) -> (), (i32, memref<512xi16>) -> (), (i32, memref<512xi16>) -> (i32))
...
func @main()->() {
  ...
  %sndo = constant @write_samples : (i32, memref<512xi16>)->(i32)
  call @pitch(%inst,%kbd,%sndi,%sndo):(i32,(i32, memref<1xi8>)->(),(i32, memref<512xi16>)->(),(i32, memref<512xi16>)->(i32))->()
  return
}
